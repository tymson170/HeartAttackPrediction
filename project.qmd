...
1.  Przedstawienie zbioru danych
    ...
    1.  Źródło danych
        ...
        1.  Zawartość zbioru: informacja o ilości danych, kiedy zostały zebrane\
            Zbiór danych zawiera 1319 obserwacji i 9 cech, z czego jedna odnosi się do obecności ataku serca.\
            Zawał mięśnia sercowego, potocznie zwany atakiem serca to martwica mięśnia sercowego spowodowana jego niedokrwieniem wskutek zamknięcia tętnicy wieńcowej doprowadzającej krew do serca.[TODO cytat](https://web.archive.org/web/20150224034615/http://www.nhlbi.nih.gov/health/health-topics/topics/cad/signs)
...
=======
            |--------------------------|------------------------------------------------------------------------------------------------------|
>>>>>>> 1446a4e3cf6e71a3575d576ae4ff483e86410a97
...
4.  Opis zbioru / statystyczna analiza opisowa - summary, statystyki opisowe\
    ...
    ```{r}
    #df %>%
    #  summarise() TODO jakas ladna tabelka?
    ```
