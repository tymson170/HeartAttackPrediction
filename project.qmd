...
Podział zbioru danych (80% dane treningowe i 10% dane testowe)
...
```{r}
modelsummary(list("Model 1" = model, "Model 2" = model4), coef_omit = 2:9)
```
