...
# todo jako tabelka ponizsze
Regresja logistyczna ze wszystkimi zmiennymi: []%

Drzewo decyzyjne ze wszystkimi zmiennymi: []%

Drzewo decyzyjne bez zmiennych CK.MB i Troponin: []%

Regresja logistyczna bez zmiennych CK.MB i Troponin: []%
...
Lekarze stwierdzając świeży zawał mięśnia sercowego, stosują wartość odcięcia (czyli wartość powyżej 99 centyla zakresu referencyjnego).
Dla troponiny ta wartość wacha się od $0,01 \mu g/l$ do $0,08 \mu g/l$ w zależności od producenta testu.
W naszym modelu wartość, od której decydujemy czy ktoś ma zawał dla troponiny wynosi `r `. (~0.015)
# TODO wpisac wartosc z modelu i dopisac jak sie ma do stosowanego przez lekarzy i dac bibliografie do tego.
